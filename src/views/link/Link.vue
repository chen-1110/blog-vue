<template>
  <div>
    ...
    <v-card class="blog-container">
      ...
      <blockquote>
        <div>名称：包子博客</div>
        <div>简介：我在快节奏里慢慢来，不加入马戏团</div>
        <div>头像：https://tse3-mm.cn.bing.net/th/id/OIP.N9gKzFp25pPG7h7sIVznSwHaHa?pid=ImgDet&rs=1</div>
      </blockquote>
      <div class="mt-5 mb-5">
        需要交换友链的可留言至邮箱1223325118@qq.com💖
      </div>
...
.link-banner {
  background: url(https://w.wallhaven.cc/full/lm/wallhaven-lmo76p.jpg) center center /
    cover no-repeat;
