  ...
  <div>
    ...
    <div class="home-banner">
      <div class="banner-container">
        ...
        <div class="blog-intro2">
          {{ obj.output }} <span class="typed-cursor">|</span>
        </div>

        <!-- 联系方式 -->    <!--这里的联系方式用于移动端，浏览器端看不到  annotation by chen-->
        <div class="blog-contact">
          <a
            class="iconfont iconqq"
            target="_blank"
            href="http://wpa.qq.com/msgrd?v=3&uin=1223325118&site=qq&menu=yes"
          />
          <a
            target="_blank"
            href="https://github.com/chen-1110"
...
<!--              </router-link>-->
      ...
      <v-col md="3" cols="12" class="d-md-block d-none">
        <div class="blog-wrapper">
          <!--博主信息（头像，博客数量统计，联系方式等） annotation by chen-->
          <v-card class="animated zoomIn blog-card mt-5">
            <!--博主信息 annotation by chen-->
            <div class="author-wrapper">
              <!-- 博主头像 annotation by chen-->
              <v-avatar size="110">
                <img class="author-avatar" src="https://tse3-mm.cn.bing.net/th/id/OIP.N9gKzFp25pPG7h7sIVznSwHaHa?pid=ImgDet&rs=1" />
              </v-avatar>
              <!--博主名字-->
...
<!--              </div>-->
            ...
            <div class="card-info-social">
              ...
              <a
                target="_blank"
                href="https://gitee.com/chenzewei0412"
                class="iconfont icongitee-fill-round"
              />
            </div>
          </v-card>
          <!-- 网站信息 -->   <!--公告 annotation by chen-->
          ...
          <v-card class="blog-card animated zoomIn mt-5">
            ...
            <div class="web-info">
              ...
              <div style="padding:4px 0 0">
                总访问量:<span class="float-right">{{ blogInfo.viewCount }}</span>
              </div>
            </div>
          </v-card>
        </div>
...
export default {
  ...
  methods: {
    ...
    runTime() {
      var timeold =
        new Date().getTime() - new Date("June 13,2021").getTime();
