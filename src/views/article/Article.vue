      ...
      <v-col md="9" cols="12">
        <v-card class="article-wrapper">
          ...
          <div class="aritcle-copyright">
            <div>
              <span>文章作者：</span>
              <a href="http://localhost:8081" target="_blank">PhilChen</a>
            </div>
            <div>
              <span>文章链接：</span>
...
export default {
  ...
  methods: {
    ...
    like() {
      ...
      //let a=this.article.id;
      console.log(this.article.id);
      console.log(param);
      this.axios.post("/api/articles/like", {"articleId":this.article.id }).then(() => {
        //判断是否点赞
