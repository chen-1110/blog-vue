      ...
      <div style="display:flex">
        <v-avatar size="40">
          <img
            ...
            src="https://img.ixintu.com/download/jpg/202001/8ba450657afc0be00c65d8751b09beb3.jpg!con"
          />
          <img
            v-else
            src="https://img.ixintu.com/download/jpg/202001/8ba450657afc0be00c65d8751b09beb3.jpg!con"
    ...
    <div v-if="count > 0 && reFresh">
      ...
      >
        ...
        <v-avatar size="40" class="comment-avatar">
          <img src="https://img.ixintu.com/download/jpg/202001/8ba450657afc0be00c65d8751b09beb3.jpg!con" />
        </v-avatar>
...
export default {
  ...
  methods: {
    replyComment(index, item) {
      ...
      this.$refs.reply[index].replyId = item.replyId;
    ...
    insertComment() {
      ...
      this.axios.post("/api/comments", comment).then(() => {
        ...
        this.$toast({ type: "success", message: "评论成功了呢！" });
      });
    },
    like(comment) {
      //判断登录
      ...
      this.axios.post("/api/comments/like", { commentId: comment.id }).then(() => {
        //判断是否点赞
    ...
    reloadReply() {
      ...
      this.commentList[0].replyCount++;
      console.log(articleId);
      this.axios
        .get("/api/comments", {
          params: { current: 0, articleId: articleId}
        })
        .then(({ data }) => {
          console.log(data);
